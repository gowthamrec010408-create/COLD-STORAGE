/**
 * Solar Smart Cold Storage — Reports & Data Export UI
 * Exports Daily/Weekly/Monthly quality audits, batch manifests,
 * and solar energy logs to PDF (jsPDF + AutoTable) and Excel (SheetJS).
 */
...
export class ReportsUI {
  render() {
    ...
    container.innerHTML = `
      <!-- Header -->
      <div class="reports-header glass-card mb-6">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            ...
            <h2 class="text-2xl font-bold mt-1">Operational Reports & Data Exports</h2>
            <p class="text-sm text-muted">Generate certified PDF certificates, sensor time-series spreadsheets, and dispatch receipts.</p>
          </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div class="glass-card report-card">
          ...
          <div class="report-actions flex gap-2 mt-4">
            <button class="btn btn-sm btn-primary export-report-btn" data-type="daily" data-format="pdf">
              <i data-lucide="file-text"></i> Download PDF
            </button>
            <button class="btn btn-sm btn-outline export-report-btn" data-type="daily" data-format="xlsx">
        ...
        <div class="glass-card report-card">
          ...
          <div class="report-actions flex gap-2 mt-4">
            <button class="btn btn-sm btn-primary export-report-btn" data-type="quality" data-format="pdf">
              <i data-lucide="file-text"></i> Download PDF
            </button>
            <button class="btn btn-sm btn-outline export-report-btn" data-type="quality" data-format="xlsx">
              <i data-lucide="table"></i> Excel
            </button>
          </div>
        </div>
        ...
        <div class="glass-card report-card">
          ...
          <div class="report-actions flex gap-2 mt-4">
            <button class="btn btn-sm btn-primary export-report-btn" data-type="energy" data-format="pdf">
              <i data-lucide="file-text"></i> Download PDF
            </button>
            <button class="btn btn-sm btn-outline export-report-btn" data-type="energy" data-format="xlsx">
              <i data-lucide="table"></i> Excel
            </button>
          </div>
        </div>
...
export const reportsUI = new ReportsUI();
